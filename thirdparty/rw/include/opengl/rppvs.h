 ...
 *
 * \param value     A value between 0.0 and 100.0 to represent the percentage 
 *                  completion.
 * \param msg       The message may take one of the following:
 *                  \li rpPVSPROGRESSSTART
 *                  The PVS creation process is about to start. The argument 
 *                  value is equal to 0.0.
 *                  \li rpPVSPROGRESSUPDATE
 *                  The PVS creation process has finished processing a 
 *                  subsection of the world. The argument value is equal to 
 *                  the percentage of the world processed up to this point.
 *                  \li rpPVSPROGRESSEND
 *                  The PVS creation process has ended. All world sectors 
 *                  have been processed. The argument value is equal to 100.0.
 *
 * \return  The progress callback may return FALSE to indicate that the 
 *          generation of PVS data should terminate. Otherwise, return 
 *          TRUE to continue.
 *
 */
 ...
 *
 * \return Pointer to the current world sector or NULL to terminate the 
 *         iteration and exit early.
 */
