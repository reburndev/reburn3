 ...
 *
 * \param atomic   Pointer to atomic for which the LOD value is being
 *                 calculated
 * \param userData Pointer to the user supplied data
 *
 * \return LOD of the atomic in the range \ref rpPATCHLODMINVALUE and
 *         \ref rpPATCHLODMAXVALUE (or \ref rpPATCHSKINLODMAXVALUE if
 *         atomic is skinned.)
 *
 * \see RpPatchAtomicSetPatchLODCallBack
 * \see RpPatchAtomicGetPatchLODCallBack
