...
struct RtWorldImportParameters
{
    ...
    /**< If TRUE then T-junctions are fixed in the geometry.
     *   NB: This ONLY fixes T-junctions introduces by the partitioning
     *   and not those introduced by the artist.
     */
    RwInt32             flags;
    ...
    RwBool              calcNormals;
    /**< If TRUE the vertex normals are wiped and recalculated (this might also happen
     * if conditionGeometry is TRUE).
     */
    RwBool              conditionGeometry;
    /**< If TRUE, any geometry conditioning pipeline that has been set up
     *   will be called before sectorization
     */
};
 ...
 */
typedef struct RtWorldImportBuildCallBacks RtWorldImportBuildCallBacks;
...
extern void RtWorldImportParametersInit(RtWorldImportParameters* params);
