...
/**
 * \ingroup rtltmap
 * \ref RtLtMapLightMapProcessCallBack is the callback to be called, from
 * within \ref RtLtMapLightingSessionLightMapProcess, to allow a lightmap
...
enum RtLtMapMaterialFlags
{
    ...
    rtLTMAPMATERIALVERTEXLIGHT = 32, /**< This material will be lit at vertices */
...
RtLtMapDefaultVisCallBack(RpWorld    *world,
                          RwRGBAReal *result __RWUNUSED__,
                          RwV3d      *samplePos,
                          RwV3d      *lightPos,
                          RpLight    *light);
...
extern RwBool RtLtMapSetLightMapProcessCallBack(RtLtMapLightMapProcessCallBack cback);
extern RtLtMapLightMapProcessCallBack RtLtMapGetLightMapProcessCallBack( void );
...
extern RwRGBA *RtLtMapSkyLumResetCallBack( RwRGBA *scanline, RwUInt32 width );
...
extern RwReal RtLtMapWorldCalculateDensity(RpWorld *world);
extern RwReal RtLtMapAtomicCalculateDensity(RpAtomic *atomic);
